...
class DatabaseManager:
    def __init__(self,db_name="data/db_transaction.db"):
    ...
    def add_feedback(self, f_type, description):
        """Adds a new feedback"""
    ...
    def get_all_feedback(self):
        ...
        with self.get_connection() as conn:
            cursor = conn.cursor()
            cursor.execute("""SELECT id, name, type, description, status, resolution_note FROM feedback ORDER BY date DESC""")
            return cursor.fetchall()
